...
Ak túto rigoróznosť chceš mať natrvalo (a nie ju písať pri každej úlohe), nastav si prostredie cez **`/setup-environment`**: `AGENTS.md`, guardraily always/ask/never, hooky na kritické súbory a znalostnú bázu (`/llm-wiki`, `/graphify`). Opakované úlohy sprav ako skill cez `/skill-creator`.
