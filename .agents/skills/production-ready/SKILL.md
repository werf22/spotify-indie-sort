...
Source of truth: `~/.Codex/rules/production-readiness.md`. Walk it **category by category, in batches of 5–7 categories** so the user is never staring at forty questions at once.
