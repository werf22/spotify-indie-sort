...
<!-- This file is PROJECT LAW. The global ~/.Codex/AGENTS.md handles method and persona
...
<!-- Concrete servers/CLIs behind the generic tool classes in ~/.Codex/rules/tool-routing.md.
...
Hard-protected paths live in `.Codex/protected-paths.txt` (hook-enforced — edits there are physically blocked, not just requested).
...
@.Codex/fable5-system-prompt.md
@.Codex/rules/core-portable.md
@.Codex/rules/learned-rules.md

Vendored rules live in `.Codex/rules/`, skills in `.Codex/skills/`. Cloud sessions load ONLY this repo — keep this section and the lessons import intact.
